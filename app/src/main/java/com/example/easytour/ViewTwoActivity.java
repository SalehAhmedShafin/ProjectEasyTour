...
public class ViewTwoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Rangpur");
        recyclerView=findViewById(R.id.recyclerViewRang);
            ...
            protected void onBindViewHolder(@NonNull MyDataHolder holder, int position, @NonNull Item model) {
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos == 0) {
                            Intent intent = new Intent(getApplicationContext(), SopnopuriActivity.class);
                            startActivity(intent);
                        }
                        if (pos == 1) {
                            Intent intent = new Intent(getApplicationContext(), TajhatJamidarPalaceActivity.class);
                            startActivity(intent);
                        }
                    }
                });

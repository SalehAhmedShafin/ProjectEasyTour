...
public class ViewFourActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Sylhet");
        recyclerView=findViewById(R.id.recyclerViewSylhet);
            ...
            protected void onBindViewHolder(@NonNull MyDataHolder holder, int position, @NonNull Item model) {
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos == 0) {
                            Intent intent = new Intent(ViewFourActivity.this, RatargulActivity.class);
                            startActivity(intent);
                        }
                        if (pos == 1) {
                            Intent intent = new Intent(ViewFourActivity.this, TanguarHourActivity.class);
                            startActivity(intent);
                        }
                    }
                });

...
public class ViewFiveActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Rajshahi");
        recyclerView=findViewById(R.id.recyclerViewRaj);
            ...
            protected void onBindViewHolder(@NonNull MyDataHolder holder, int position, @NonNull Item model) {
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos == 0) {
                            Intent intent = new Intent(ViewFiveActivity.this, MohastanActivity.class);
                            startActivity(intent);
                        }
                        if (pos == 1) {
                            Intent intent = new Intent(ViewFiveActivity.this, NatoreRajbariActivity.class);
                            startActivity(intent);
                        }
                    }
                });

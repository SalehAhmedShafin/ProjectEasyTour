...
public class ViewThreeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Khulna");
        recyclerView=findViewById(R.id.recyclerViewKhulna);
            ...
            protected void onBindViewHolder(@NonNull MyDataHolder holder, int position, @NonNull Item model) {
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos == 0) {
                            Intent intent = new Intent(ViewThreeActivity.this, SixtyDomeActivity.class);
                            startActivity(intent);
                        }
                        if (pos == 1) {
                            Intent intent = new Intent(ViewThreeActivity.this, HironPointActivity.class);
                            startActivity(intent);
                        }
                    }
                });

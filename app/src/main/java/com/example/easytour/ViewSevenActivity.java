...
public class ViewSevenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference= FirebaseDatabase.getInstance().getReference().child("Cumilla");
        recyclerView=findViewById(R.id.recyclerViewCummila);
            ...
            protected void onBindViewHolder(@NonNull MyDataHolder holder, int position, @NonNull Item model) {
                ...
                holder.view.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (pos == 0) {
                            Intent intent = new Intent(getApplicationContext(), MoinamatiActivity.class);
                            startActivity(intent);
                        }
                        if (pos == 1) {
                            Intent intent = new Intent(getApplicationContext(), DharmosagorActivity.class);
                            startActivity(intent);
                        }
                    }
                });
